"""Address formatting utilities shared across layers.

Contains helpers for building canonical single-line address strings used by
both the validation providers and the router layer.
"""


def build_validated_string(
